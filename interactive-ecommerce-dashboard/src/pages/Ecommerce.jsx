...
// import  { usedStateContext } from "../contexts/ContextProvider"
...
//           bg-no-repeat bg-gradient-to-r from-purple-500 to-pink-500 
//            bg-cover bg-center'>
//             <div className='flex justify-between items-center'>
//               <div>
//                 <p className='font-bold text-white '>Earnings</p>
//                 <p className='text-2xl9 text-white'>$63,448.78</p>
//               </div>
//             </div>
//           <div className='mt-6 '>
//             <Button
...
//               <p classNmae= "font-semibold text-x1"> 
//                     Revenue Updates
//               </p>
